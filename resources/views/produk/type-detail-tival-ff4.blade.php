...
@section('title', $product ? $product->name . ' - Tival FF4 Accessories Pump' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">TIVAL FF4 - ACCESSORIES PUMP</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Flow switch mekanis berkualitas tinggi</li>
                        <li>Desain tahan tekanan tinggi hingga 10 bar</li>
                        <li>Material brass atau stainless steel, tergantung tipe</li>
                        <li>Dilengkapi kontak SPDT untuk kontrol pompa otomatis</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Proteksi sistem pompa dari dry-run</li>
                        <li>Kontrol otomatis pompa booster</li>
                        <li>Instalasi HVAC dan fire pump system</li>
                        <li>Industri air bersih & pengolahan air limbah</li>
                    </ul>
