...
@section('title', $product ? $product->name . ' - Ebara Submersible Pump (DVS, DL, DS, DF)' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">EBARA SUBMERSIBLE PUMP - DVS / DL / DS / DF</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Beragam model impeller: vortex (DVS), semi-open (DS), dan kanal (DL, DF)</li>
                        <li>Body pompa tahan korosi dan abrasi</li>
                        <li>Motor submersible efisiensi tinggi dilengkapi proteksi termal</li>
                        <li>Mudah dalam pemasangan dan perawatan</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Pemompaan air limbah domestik dan industri</li>
                        <li>Drainase gedung dan basement</li>
                        <li>Sistem STP (Sewage Treatment Plant)</li>
                        <li>Aplikasi saluran pembuangan & air hujan</li>
                    </ul>
...
"
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    <img src="{{ asset('img/Dseries/dcurve.png') }}" alt="Spesifikasi DVS"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/Dseries/dcurve2.png') }}" alt="Spesifikasi DL"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                </div>

                {{-- KATALOG --}}
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/Dseries/Dseries.png') }}" alt="Katalog Submersible Ebara"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/Dseries_catalog.pdf') }}" download
