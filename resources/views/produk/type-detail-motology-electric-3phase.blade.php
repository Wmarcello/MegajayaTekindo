...
@section('title', $product ? $product->name . ' - Motology 3 Phase Motor' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">Motology Electric Motor - 3 Phase</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur Unggulan:</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Efisiensi tinggi untuk beban industri</li>
                        <li>Daya output stabil dan tahan lama</li>
                        <li>Desain kokoh dan tahan getaran</li>
                        <li>Pendingin TEFC, cocok untuk lingkungan berat</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi:</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Pompa industri, conveyor, kompresor</li>
                        <li>Penggerak mesin di pabrik dan manufaktur</li>
                        <li>Kebutuhan operasional 24 jam</li>
                    </ul>
                    ...
                    <div class="mt-4">
                        <a href="https://wa.me/6285775230813?text=Halo%20MJT,%20saya%20tertarik%20dengan%20produk%20{{ $product->name }}%203%20Phase%20dan%20ingin%20tanya%20tentang%20spesifikasi%20yang%20saya%20butuhkan%20pakai%20tipe%20apa"
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    <img src="{{ asset('img/Motology/curve3phase.png') }}" alt="Spesifikasi Motology 3 Phase"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/Motology/sparepat3phase.png') }}" alt="Spesifikasi Motology 3 Phase"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                </div>

                {{-- KATALOG PDF --}}
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/Motology/3phase.png') }}" alt="Katalog"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/Motology_3phase_Catalog.pdf') }}" download
