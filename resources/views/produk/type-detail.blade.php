...
@section('title',
    $product
    ? $product->name . ' - ' . strtoupper(str_replace('-', ' ', $type))
    : 'Produk Tidak
    Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Fungsi pintas keselamatan melindungi pompa</li>
                        <li>Untuk transfer minyak</li>
                    </ul>
            ...
            <div class="mt-10">
                ...
                {{-- SPESIFIKASI (gambar tabel & grafik) --}}
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    <img src="{{ asset('img/koshin/koshin_gl2.png') }}" alt="Spesifikasi GL Series"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/koshin/koshin_gl3.png') }}" alt="Spesifikasi GL Series"
                ...
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/koshin/koshin_gl1.png') }}" alt="Katalog Koshin"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/koshin_GL.pdf') }}" download
