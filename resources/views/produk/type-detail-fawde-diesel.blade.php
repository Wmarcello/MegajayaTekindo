...
@section('title', $product ? $product->name . ' - FAWDE 4DX23 Diesel Engine' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">FAWDE 4DX23 - DIESEL ENGINE</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur Unggulan :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Mesin 4 silinder turbocharged dengan efisiensi tinggi</li>
                        <li>Daya output kuat dan stabil untuk berbagai aplikasi</li>
                        <li>Teknologi injeksi bahan bakar modern dan hemat BBM</li>
                        <li>Kualitas buatan tinggi dengan perawatan minimal</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Genset industri dan komersial</li>
                        <li>Pompa air dan peralatan teknik</li>
                        <li>Alat berat dan kendaraan niaga</li>
                        <li>Mesin konstruksi dan pertanian</li>
                    </ul>
...
"
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    <img src="{{ asset('img/fawde/curve.png') }}" alt="Spesifikasi FAWDE 4DX23"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/fawde/curve2.png') }}" alt="Spesifikasi Tambahan"
                        class="w-full max-w-2xl rounded shadow border mx-auto mt-10">
                </div>

                {{-- KATALOG --}}
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/fawde/4dx23.png') }}" alt="Katalog FAWDE 4DX23"
