...
@section('title', $product ? $product->name . ' - Titan Electric Motor' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">TITAN ELECTRIC MOTOR</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur Utama :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Motor induksi 3 phase efisiensi tinggi</li>
                        <li>Konstruksi kuat & tahan lama, cocok untuk industri</li>
                        <li>Pendingin eksternal (TEFC) untuk kerja berat</li>
                        <li>Standar IEC & IP55 protection</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Penggerak pompa & kompresor</li>
                        <li>Mesin conveyor & industri manufaktur</li>
                        <li>Pengaduk, blower, dan peralatan mekanis lainnya</li>
                        <li>Industri umum, tambang, pabrik, workshop</li>
                    </ul>
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/titan/titan_1.png') }}" alt="Katalog Titan Electric Motor"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/Titan_Catalog.pdf') }}" download
