...
@section('title', $product ? $product->name . ' - Pump Couple Titan' : 'Produk Tidak Ditemukan')
...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{
        ...
        get waMessage() {
            return `Halo MJT, saya tertarik dengan produk Pump Couple Titan dan ingin konsultasi mengenai kebutuhan saya dengan merek pompa ${this.pumpBrand}, kapasitas ${this.flowRate} m3/h, head ${this.head} meter, dan motor ${this.pole} pole.`;
        },
        resetForm() {
            this.pumpBrand = '';
            this.flowRate = '';
        ...
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                <div class="text-center relative">
                    <img src="{{ asset($product->image) }}" alt="Pump Couple Titan"
                        class="mx-auto max-h-[350px] object-contain mb-4 transition duration-300 ease-in-out">
                </div>

                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-2">Pump Centrifugal + Titan Electric</h1>
                    <div class="w-14 h-1 bg-red-600 mb-5 rounded"></div>
                    <h2 class="text-lg font-semibold mb-1">Fitur :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Dilengkapi motor Titan berkualitas untuk performa stabil</li>
                        <li>Rangkaian kopel fleksibel mendukung daya tahan tinggi</li>
                        <li>Konstruksi simpel namun kuat untuk berbagai kondisi kerja</li>
                        <li>Biaya operasional rendah dan mudah dalam perawatan</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Distribusi air dan sistem pemompaan umum</li>
                        <li>Industri ringan, komersial, dan pertanian</li>
                        <li>Pabrik, gudang, dan fasilitas air bersih</li>
                    </ul>
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    ...
                    <img src="{{ asset('img/cwTitan/specTitan.png') }}" alt="Spesifikasi"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/titan/titankw.png') }}" alt="Spesifikasi Titan Motor"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/titan/titankw2.png') }}" alt="Spesifikasi Tambahan"
                        class="w-full max-w-2xl rounded shadow border mx-auto mt-10">
                </div>

                {{-- DIMENSION --}}
                <div x-show="tab === 'dimension'" class="space-y-6">
                    <img src="{{ asset('img/cwTitan/b3Titan.png') }}" alt="Dimension"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/cwTitan/b5Titan.png') }}" alt="Dimension"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/cwTitan/b35Titan.png') }}" alt="Dimension"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                </div>
            </div>
        @else
