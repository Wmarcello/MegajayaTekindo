...
@section('title', $product ? $product->name . ' - TECO AE-VS Electric Motor' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">TECO AE-VS - ELECTRIC MOTOR</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur Unggulan :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Efisiensi tinggi IE2/IE3 sesuai standar IEC</li>
                        <li>Desain rangka kokoh dan tahan terhadap getaran</li>
                        <li>Dilengkapi pendingin external fan (TEFC)</li>
                        <li>Perawatan mudah dengan bearing berkualitas tinggi</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Pompa industri & HVAC</li>
                        <li>Kompressor, conveyor, dan penggerak mesin</li>
                        <li>Pabrik, workshop, dan fasilitas umum lainnya</li>
                        <li>Lingkungan kerja berat dan terus-menerus</li>
                    </ul>
...
"
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/Teco/aesv1s.png') }}" alt="Katalog TECO AE-VS"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/AEVS.pdf') }}" download
