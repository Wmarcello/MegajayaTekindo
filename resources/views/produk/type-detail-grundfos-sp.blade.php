...
@section('title', $product ? $product->name . ' - Grundfos SP Submersible Pump' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">GRUNDFOS SP - SUBMERSIBLE PUMP</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Didesain khusus untuk sumur dalam (deep well) hingga 600 meter</li>
                        <li>Material full stainless steel, tahan korosi dan abrasi</li>
                        <li>Motor efisiensi tinggi dengan pendinginan optimal</li>
                        <li>Kompatibel dengan sistem kontrol digital (CU3X0, MP204, dll)</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Sistem sumur dalam industri & domestik</li>
                        <li>Penyediaan air bersih skala besar (PDAM, irigasi)</li>
                        <li>Pertambangan, pembangkit listrik, dan peternakan</li>
                        <li>Pengisian reservoir dan transfer air jarak jauh</li>
                    </ul>
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    <img src="{{ asset('img/Grundfos/spcurve.png') }}" alt="Spesifikasi Grundfos SP"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/Grundfos/spcurve2.png') }}" alt="Dimensi dan Detail"
                        class="w-full max-w-2xl rounded shadow border mx-auto mt-10">
                </div>

                {{-- KATALOG --}}
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/Grundfos/Spgrundfos.png') }}" alt="Katalog Grundfos SP"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/Grundfos_catalog_Sp.pdf') }}" download
