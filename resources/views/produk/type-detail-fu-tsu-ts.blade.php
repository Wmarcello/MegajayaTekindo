...
@section('title', $product ? $product->name . ' - Futsu Bowler TS' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">FUTSU BLOWER - TYPE TS</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Desain roots blower tiga lobus untuk efisiensi tinggi</li>
                        <li>Struktur kokoh dan tahan lama</li>
                        <li>Operasi dengan getaran rendah dan suara halus</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Instalasi pengolahan air limbah</li>
                        <li>Pengangkutan pneumatik</li>
                        <li>Suplai udara pembakaran</li>
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    <img src="{{ asset('img/futsu/futsu_dimensi.png') }}" alt="Struktur TS Blower"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                </div>

                {{-- KATALOG --}}
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/futsu/Futsu_TS.png') }}" alt="Katalog Futsu TS"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/Futsu_Catalog.pdf') }}" download
