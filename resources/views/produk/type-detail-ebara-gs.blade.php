...
@section('title', $product ? $product->name . ' - GS Centrifugal End Suction' : 'Produk Tidak Ditemukan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ tab: 'spesifikasi' }">
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl font-extrabold mb-2">EBARA GS - CENTRIFUGAL END SUCTION</h1>
                    <div class="w-10 h-1 bg-gray-300 mb-4"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Impeller tertutup berbahan stainless steel</li>
                        <li>Desain heavy-duty dan efisiensi tinggi</li>
                        <li>Cocok untuk aplikasi industri berat dan pengolahan kimia</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Transfer cairan kimia</li>
                        <li>Sistem pendingin & pemanas (HVAC)</li>
                        <li>Pabrik makanan dan minuman</li>
                        <li>Aplikasi industri berat</li>
                    </ul>
