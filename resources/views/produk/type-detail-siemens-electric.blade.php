...
@section('title', $product ? $product->name . ' - Siemens 1LE0 Electric Motor' : 'Produk Tidak Ditemukan')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Efisiensi tinggi IE2 / IE3 sesuai IEC 60034</li>
                        <li>Motor 3-phase asinkron dengan desain ringkas</li>
                        <li>Konstruksi kokoh dengan aluminium atau besi cor</li>
                        <li>Proteksi IP55 dan pendinginan TEFC</li>
                        <li>Standar pemasangan IEC: B3, B5, B35.</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Penggerak pompa, blower, dan kompresor</li>
                        <li>Sistem conveyor, mixer, dan proses industri</li>
                        <li>Pabrik manufaktur & automasi mesin</li>
                        <li>HVAC, pengolahan air, dan aplikasi umum</li>
                    </ul>
...
"
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'katalog'" class="text-center space-y-4">
                    <img src="{{ asset('img/siemens/1leo.png') }}" alt="Katalog Siemens 1LE0"
                        class="mx-auto max-h-[250px] object-contain rounded shadow border">
                    <a href="{{ asset('pdf/Siemens.pdf') }}" download
