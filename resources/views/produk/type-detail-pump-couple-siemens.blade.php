...
@section('title', $product ? $product->name . ' - Pump Couple Siemens' : 'Produk Tidak Ditemukan')
...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{
        ...
        get waMessage() {
            return `Halo MJT, saya tertarik dengan produk Pump Couple Siemens dan ingin konsultasi mengenai kebutuhan saya dengan merek pompa ${this.pumpBrand}, kapasitas ${this.flowRate} m3/h, head ${this.head} meter, dan motor ${this.pole} pole.`;
        },
        resetForm() {
            this.pumpBrand = '';
            this.flowRate = '';
        ...
        @if ($product)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                ...
                <div class="text-center relative">
                    <img src="{{ asset($product->image) }}" alt="Pump Couple Siemens"
                        class="mx-auto max-h-[350px] object-contain mb-4 transition duration-300 ease-in-out">
                </div>

                {{-- Detail Produk --}}
                <div>
                    <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-800 mb-2">Pump Centrifugal + Siemens Electric
                    </h1>
                    <div class="w-14 h-1 bg-red-600 mb-5 rounded"></div>

                    <h2 class="text-lg font-semibold mb-1">Fitur :</h2>
                    <ul class="list-disc list-inside text-gray-700 mb-4 space-y-1">
                        <li>Motor listrik Siemens 2 Pole / 4 Pole</li>
                        <li>Konstruksi kokoh dengan kopel fleksibel</li>
                        <li>Efisiensi tinggi dan perawatan mudah</li>
                        <li>Cocok untuk aplikasi industri berat</li>
                    </ul>

                    <h2 class="text-lg font-semibold mb-1">Aplikasi :</h2>
                    <ul class="list-disc list-inside text-gray-700 space-y-1">
                        <li>Sistem sirkulasi dan suplai air</li>
                        <li>Instalasi industri dan pabrik</li>
                        <li>Pertambangan dan irigasi</li>
                    </ul>
            ...
            <div class="mt-10">
                ...
                <div x-show="tab === 'spesifikasi'" class="space-y-6">
                    ...
                    <img src="{{ asset('img/siemens/siemenskw.png') }}" alt="Spesifikasi Siemens 1LE0"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/siemens/siemenskw2.png') }}" alt="Spesifikasi Tambahan"
                        class="w-full max-w-2xl rounded shadow border mx-auto mt-10">
                </div>

                {{-- DIMENSION --}}
                <div x-show="tab === 'dimension'" class="space-y-6">
                    <img src="{{ asset('img/cwSiemens/b3Siemens.png') }}" alt="dimension"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
                    <img src="{{ asset('img/cwSiemens/b5Siemens.png') }}" alt="dimension"
                        class="w-full max-w-2xl rounded shadow border mx-auto">
