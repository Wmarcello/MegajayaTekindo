...
<body class="min-h-screen scroll-smooth overflow-x-hidden d-flex flex-column"
    style="min-height:100vh; display:flex; flex-direction:column;">

    <div class="min-h-full main-content flex-1">
        <nav class="bg-stone-100 z-50 relative" x-data="{ isOpen: false }">
